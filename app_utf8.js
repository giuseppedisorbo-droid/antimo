...
function renderActivitiesList() {
    ...
    if(toDO.length > 0) {
        toDO.sort((a,b) => {
            const dateA = a.dataPrevista || "9999-12-31";
            const dateB = b.dataPrevista || "9999-12-31";
            if (dateA !== dateB) return dateA.localeCompare(dateB);
            const timeA = a.oraPrevista || "23:59";
            const timeB = b.oraPrevista || "23:59";
